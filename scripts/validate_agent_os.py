...
PUBLIC_PRIVACY_PATTERNS: list[tuple[str, re.Pattern[str]]] = [
    (
        "URL de página privada do Notion",
        re.compile(r"https://app\.notion\.com/p/[0-9a-f]{32}(?:\?[^\s)]*)?", re.IGNORECASE),
    ),
    (
        "URL do Notion com identificador concreto",
        re.compile(r"https://(?:www\.)?notion\.so/[^\s)]*[0-9a-f]{32}(?:\?[^\s)]*)?", re.IGNORECASE),
    ),
    (
        "identificador concreto de data source do Notion",
        re.compile(r"collection://[0-9a-f]{8}(?:-[0-9a-f]{4}){3}-[0-9a-f]{12}", re.IGNORECASE),
    ),
    (
        "caminho local de usuário no Windows",
        re.compile(r"[A-Za-z]:\\Users\\(?!Example(?:\\|$))[^\\\s]+\\", re.IGNORECASE),
    ),
    (
        "caminho local de usuário Unix",
        re.compile(r"/(?:home|Users)/(?!example(?:/|$))[^/\s]+/", re.IGNORECASE),
    ),
    (
...
PRIVATE_PHRASE_HASHES = {
    ...
    "505a273570ca56047c4eb3f420da358ba958ffb2d2b7ad3c3c816f15f4451be4",
    "f0d9991c5e47e0d26a350c1618bd3154cd0f9f2461d3df671a753c393fe7a6a7",
    "08375490156ef328bb0e4266407d43dd49434dd823b2af71553bf89f360f5fd5",
    "5b4245d59aec80a3042c6f57af5eba73b6d4572c7597cd0d72be34ea7b51ccc7",
    "1426db568ced337fabba208afbb0200ccf0cea99622300134148caa1b4fbe283",
    "32c4d6efbac5730ce47b612e644d4d961d7b70caa3eddf51c7be0528de633481",
    "216e6fbc15d2ad97f4910ef225412f40f797c8ba6eef1c3dd9b52304cfb22a63",
    "dacf9ba53d3038ae8b8c4ec724c48b919f4f4e5897189d33e6bba0874e079bfc",
    "1172b79eec1555c69ba6088631f7fe1061982ae746d232879d41b945eac57b66",
    "3e61f3d72584db6d7385b8ec05842f864f89294452a32ad82760c6b8e5efaa6e",
}
...
def contains_private_phrase_fingerprint(text: str) -> bool:
    ...
    for size in range(1, max_ngram + 1):
        for start in range(0, len(tokens) - size + 1):
            ...
            if digest in PRIVATE_PHRASE_HASHES:
                return True
    return False
...
def main() -> int:
    ...
    required = [
        ...
        "SECURITY.md",
        "CONTRIBUTING.md",
        "docs/architecture/SPEC-AGENT-OS.md",
        "docs/governance/SECURITY-MODEL.md",
        "docs/governance/PUBLIC-SANITIZATION.md",
        "docs/release/PUBLIC-RELEASE.md",
        "docs/notion/START-HERE.md",
        "docs/notion/NOTION-BRAIN-ARCHITECTURE.md",
        "docs/notion/MARKDOWN-LIBRARY-MEMORY.md",
        "docs/notion/DATABASE-SCHEMAS.md",
        "scripts/build_public_snapshot.py",
        ".github/workflows/build-public-snapshot.yml",
        "templates/repository/START-HERE.md",
    ...
    if agents.exists():
        ...
        if line_count > 200:
            warnings.append(f"AGENTS.md tem {line_count} linhas; considere reduzir para menos de 200.")
